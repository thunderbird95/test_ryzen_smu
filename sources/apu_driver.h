...
public:
    ...
    EXP int CALL set_gfx_clk_auto(ryzen_access ry);
    EXP int CALL set_fclk_and_memclk(ryzen_access ry, uint32_t value);
    EXP int CALL set_fclk_and_memclk_auto(ryzen_access ry);

    // TODO: add real set_cogfx fxn (pmu, 0x53), gfx_clk_auto (pmu, 0x8A)
